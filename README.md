...
```
sudo apt-get install git cmake make gcc-4.6 g++-4.6 build-essential libqt4-dev libqca2-dev libboost-program-options-dev libboost-filesystem-dev libzeroc-ice34-dev
```
